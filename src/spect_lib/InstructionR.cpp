...
spect::InstructionR::InstructionR(std::string mnemonic, uint32_t opcode, uint32_t func,
                                  CpuGpr op1, CpuGpr op2, CpuGpr op3) :
    Instruction(mnemonic, InstructionType::R, opcode, func, 3),
    op1_(op1),
    op2_(op2),
    op3_(op3)
{}
...
spect::Instruction* spect::InstructionR::DisAssemble(uint32_t wrd)
{
    ...
    spect::InstructionR *cln = (spect::InstructionR*) spect::InstructionFactory::
