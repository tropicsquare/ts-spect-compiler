//   Ordt 220701.01 autogenerated file 
//   Input: /projects/tropic01/work/oille/tassic_clean/modules/ts-spect/reg_map/reg_map.rdl
//   Parms: /projects/tropic01/work/oille/tassic_clean/modules/ts-spect/scripts/ordt_param_file
//   Date: Tue Oct 11 11:15:35 CEST 2022
//
...
class ordt_rg_r_block_id : public ordt_reg {
  public:
    ordt_field<uint32_t> f_id_code;
    ordt_field<uint_fast8_t> f_rev_code;
    ordt_rg_r_block_id(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_r_command : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> f_start;
    ordt_field<uint_fast8_t> f_soft_reset;
    ordt_rg_r_command(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_r_status : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> f_idle;
    ordt_field<uint_fast8_t> f_done;
    ordt_field<uint_fast8_t> f_err;
    ordt_rg_r_status(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_rg_r_int_ena : public ordt_reg {
  public:
    ordt_field<uint_fast8_t> f_int_done_en;
    ordt_field<uint_fast8_t> f_int_err_en;
    ordt_rg_r_int_ena(uint64_t _m_startaddress, uint64_t _m_endaddress);
    virtual int write(const uint64_t &addr, const ordt_data &wdata);
    virtual void write(const ordt_data &wdata);
    virtual int read(const uint64_t &addr, ordt_data &rdata);
    virtual void read(ordt_data &rdata);
...
class ordt_root : public ordt_regset {
  public:
    ordt_rg_r_block_id r_block_id;
    ordt_rg_r_command r_command;
    ordt_rg_r_status r_status;
    ordt_rg_r_int_ena r_int_ena;
    ordt_root();
